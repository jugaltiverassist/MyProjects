...
$sql="Select ae.empId,ae.empName,a.date,a.status from attendance a INNER JOIN addemp ae on ae.empId=a.empId";
...
if ($result->num_rows > 0) 
{
    ...
    {   
         ...
         echo "   </div>";
         echo "   <div class="."col-lg-3".">";
         echo "       <label class="."control-label"."> " . $row["date"]. "</label>";
         echo "   </div>";
         echo "   <div class="."col-lg-3".">";
         echo "       <label class="."control-label"."> " . $row["status"]. "</label>";
         echo "   </div>";
         echo "     </div>";
